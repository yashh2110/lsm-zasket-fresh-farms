    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      >
        <View style={{ backgroundColor: "white", padding: 15, marginTop: 10 }}>
          ...
          <TouchableOpacity
            onPress={() => onPressWhatsapp(supportData?.whatsAppUrl)}
            style={{
              borderWidth: 1,
              borderColor: "#EFEFEF",
              borderRadius: 6,
          ...
          >
            ...
            >
              <Text style={{ color: "#727272", fontSize: 12.5, marginTop: -5 }}>
                Send message
              </Text>
          ...
          <TouchableOpacity
            onPress={() => callToThisNumber(supportData?.contactNumber)}
            style={{
              borderWidth: 1,
              borderColor: "#EFEFEF",
              borderRadius: 6,
