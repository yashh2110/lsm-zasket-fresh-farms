        ...
        RazorpayCheckout.open(options)
          .then(async (data) => {
            ...
            paymentConfirm(paymentInfo, (res, status) => {
              if (status) {
                initialFunction();
                AppEventsLogger.logPurchase(item?.finalPrice, "INR", {
                  param: "value",
                });
    ...
    <View style={{ flex: 1, backgroundColor: "white" }}>
      ...
      >
          ...
          <View style={{ flex: 1, flexDirection: "row", marginTop: 10 }}>
            <View style={{ flex: 1 }}>
              <Text style={{ color: "#909090", fontSize: 13 }}>
                {moment(item?.slotStartTime).format("DD MMM")} (
                {moment(item?.slotStartTime)
                  .add(1, "minutes")
                  .format("hh:mm A")}{" "}
                -{" "}
                {moment(item?.slotEndTime).add(1, "minutes").format("hh:mm A")})
              </Text>
              {/* <Text></Text> */}
            </View>
            <View>
              ...
              {item?.orderState == "DELIVERED" && (
                <Text style={{}}>
                  <Icon
                    name="checkcircle"
                    type="AntDesign"
                    style={{ fontSize: 16, color: "#49C32C" }}
                  />{" "}
                  Delivered
                </Text>
              )}
              {item?.orderState == "CANCELLED" && (
                ...
                >
                  <Icon
                    name="cancel"
                    type="MaterialIcons"
                    style={{ fontSize: 16, color: "#E1171E" }}
                  />
          ...
          >
            {showCancelButton ? (
              ...
              item?.orderState == "REFUNDED" ? (
                ...
                >
                  <Text style={{ color: "#F5B0B2", fontWeight: "bold" }}>
                    Cancel Order{" "}
                  </Text>
                </View>
              ) : (
                <TouchableOpacity
                  onPress={() => {
                    navigation.navigate("CancelOrderScreen", { item: item });
                  }}
                  style={{
                    flex: 1,
                    padding: 5,
        ...
        >
          ...
          <View style={{ backgroundColor: "white", flexDirection: "row" }}>
            ...
            >
              ...
              <Text style={{ color: "#727272" }}>
                {item?.associatedAddress?.recepientMobileNumber}{" "}
              </Text>
            </View>
          </View>
          ...
          <Text style={{ color: "#909090", fontSize: 13 }}>
            {item?.associatedAddress?.addressLine_1}{" "}
          </Text>
        </View>
        <View
          style={{
            ...
            <>
              ...
              >
                <Text style={{ color: "#35B332" }}>
                  Coupon Discount (
                  {item?.applied_offer?.offerCode
                    ? item?.applied_offer?.offerCode
                    : 0}
                  )
                </Text>
                {(item?.totalPrice - item?.offerPrice)?.toFixed(2) ==
                0 ? null : (
                  <Text style={{ color: "#35B332" }}>
                    - ₹{(item?.totalPrice - item?.offerPrice)?.toFixed(2)}{" "}
                  </Text>
              ...
              >
                ...
                >
                  <Image
                    ...
                    resizeMode="contain"
                    source={
                      item?.item?.itemImages[0]?.mediumImagePath
                        ? { uri: item?.item?.itemImages[0]?.mediumImagePath }
                ...
                <View style={[{ padding: 10, flex: 1 }]}>
                  ...
                  {item?.state == "RETURNED" ? (
                    ...
                    >
                      ...
                      >
                        <Text style={{ fontSize: 12, color: "#E1171E" }}>
                          Returned
                        </Text>
                      </View>
                    </View>
