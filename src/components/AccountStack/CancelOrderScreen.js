      ...
      >
        ...
        >
          ...
          >
            ...
            {item?.cancellationRefundInfo != null &&
            (item?.refundedAmount != 0 || item?.refundedAmount != null) ? (
              <Text style={{ color: "#909090", marginLeft: 25 }}>
                ₹ {item?.cancellationRefundInfo?.eligibleRefundAmount}{" "}
              </Text>
            ) : null}
          </View>
        </View>
        ...
        >
          ...
          <View style={{ flex: 1, flexDirection: "row", flexWrap: "wrap" }}>
            <Text style={{ color: "#909090", fontSize: 13 }}>
              Please tell us the reason for cancellation. This information is
          ...
          {cancelReasons?.map((el, index) => {
            return (
              ...
              >
                ...
                >
                  <Radio
                    selected={selectedReason?.id == el?.id ? true : false}
        ...
        {selectedReason?.id == 1 ? (
          ...
          >
            ...
            <View
              style={[styles.textAreaContainer, { borderColor: errorColor }]}
            >
              <TextInput
                onTouchStart={() => {
                  setErrorColor("#909090");
                }}
                onChangeText={(text) => {
        ...
        >
          {item?.cancellationRefundInfo != null &&
          (item?.refundedAmount != 0 || item?.refundedAmount != null) ? (
            <Text style={{ marginBottom: 10, color: "#909090", fontSize: 14 }}>
              <Text
                style={{ marginLeft: 25, color: "black", fontWeight: "bold" }}
              >
                ₹ {item?.cancellationRefundInfo?.eligibleRefundAmount}{" "}
              </Text>{" "}
              will be refunded to you with in 4-5 working days{" "}
            </Text>
          ) : (
            <Text style={{ marginBottom: 10, color: "#909090", fontSize: 14 }}>
              {" "}
              Your order will be canceled. Do you want to continue?{" "}
            </Text>
          )}
        </View>
