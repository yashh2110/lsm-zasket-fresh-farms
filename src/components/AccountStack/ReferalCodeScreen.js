...
const ReferalCodeScreen = ({ route, navigation, getCreditTransactions }) => {
  ...
  const whatsupShare = async () => {
    ...
    let url =
      "whatsapp://send?text=" +
      `Download Zasket, the one app for all your grocery needs. Get free 500g of Tomato, Onion, Potato on your first order with my referral code ${referal}\ ` +
      appUrl;
    Linking.openURL(url)
      .then((data) => {
          ...
          <View style={{ flex: 1, backgroundColor: "#f4f4f4" }}>
            <View style={{ flex: 1 }}>
              ...
              >
                ...
                <View
                  style={{ alignItems: "center", width: "65%", marginTop: 8 }}
                >
                  <Text
                    style={{
                      fontSize: 22,
                  ...
                  >
                    ...
                    <View style={{}}>
                      <Icon
                        name="copy"
                        type="Entypo"
                        style={{ fontSize: 24, color: "#e1171e" }}
                      />
                    </View>
                  </TouchableOpacity>
                </View>
                <View
                  style={{ backgroundColor: "white", padding: 8, marginTop: 7 }}
                >
                  <Text
                    style={{
                      color: "#000000",
              ...
              >
                <View style={{ width: "95%", alignSelf: "center" }}>
                  ...
                  <Text style={{ marginVertical: 3 }}>
                    2. Your friends clicks on the link or signs up through the
                    code
                  </Text>
                  <Text style={{ marginVertical: 3 }}>
                    3. You get Rs 50 in your Zasket wallet, Rs 25 each on first
                    & second orders placed by referee.
                  </Text>
                  <Text style={{ marginVertical: 3 }}>
                    4. Maximum of Rs 500 can be earned by referrals.
                  </Text>
                  {copymessage ? (
                    <View
                      style={{
...
export default connect(mapStateToProps, { getCreditTransactions })(
  ReferalCodeScreen
);
