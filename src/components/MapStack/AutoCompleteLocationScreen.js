          ...
          Geolocation.getCurrentPosition(
            async (position) => {
              ...
              this.props.navigation.navigate(navigateTo, {
                regionalPositions: region,
                fromScreen: fromScreen,
                backToCardScreen: backToCardScreen,
                backToCheckoutScreen: backToCheckoutScreen,
                backToAddressScreen: backToAddressScreen,
              });
            },
            (error) => {
              console.warn(error);
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#F8F8F8" }}>
          <View
            ...
            <TouchableOpacity
              ...
              <Icon
                ...
                type="Entypo"
                style={[{ fontSize: 32, color: "black", marginRight: 20 }]}
              />
            </TouchableOpacity>
          ...
          <View
            ...
            <View style={{ backgroundColor: "#F8F8F8", flex: 1 }}>
              ...
              <View
                style={{ position: "relative", height: 65, marginTop: "4%" }}>
