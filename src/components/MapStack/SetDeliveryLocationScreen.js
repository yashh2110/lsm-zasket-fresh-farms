...
const SetDeliveryLocationScreen = ({ navigation, darkMode, setDarkMode, login, addHomeScreenLocation, homeScreenLocation }) => {
    useEffect(() => {
        const backAction = () => {
            BackHandler.exitApp()
        };
    ...
    const onSubmit = async () => {
        navigation.navigate('MapScreenGrabPincode', { fromScreen: 'SetDeliveryLocationScreen' })
    }
                ...
                <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
                    <View style={{ width: "90%", alignSelf: "center", flex: 1, }}>
                        ...
                        <View>
                            ...
                            <Button full style={{ marginTop: "15%", backgroundColor: Theme.Colors.primary, borderRadius: 25, marginHorizontal: 20, }} onPress={() => onSubmit()}>
                                <Text style={{ textTransform: 'capitalize' }}><Icon name='location-sharp' style={{ color: '#ffffff', fontSize: 19 }} /> SET DELIVERY LOCATION</Text>
                            </Button>
                        </View>
...
export default connect(mapStateToProps, { setDarkMode, login, loginWithProvider, addHomeScreenLocation })(SetDeliveryLocationScreen)
