        ...
        <ScrollView style={{ flex: 1, backgroundColor: 'white' }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ flexDirection: 'row', backgroundColor: 'white', height: 160 }}>
                <TouchableOpacity onPress={() => { }} style={{ flex: 1, margin: 15, backgroundColor: '#F2F5F7', borderRadius: 4 }}>
                    ...
                    <Image
                        style={{ position: 'absolute', bottom: 0, right: 0, borderRadius: 5, alignSelf: 'center' }}
                        // resizeMode={"stretch"}
            ...
            <View style={{ backgroundColor: 'white', height: 140, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                <View style={{
                    backgroundColor: 'white', height: 120, borderRadius: 5, shadowColor: "#000", shadowOffset: { width: 0, height: 2, }, shadowOpacity: 0.25, shadowRadius: 3.84, elevation: 5,
                }}>
                    <Image
