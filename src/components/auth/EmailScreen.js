...
const EmailScreen = ({
  ...
  const [visiableuserReferralCode, setVisiableuserReferralCode] = useState(
    true
  );
          ...
          await createNewCustomer(payLoad, (response, status) => {
            ...
            if (status) {
              ...
              if (
                ...
                "Customer with details already exist!!. Please sign in"
              ) {
                navigation.navigate("Login");
                Toast.show({
                  text:
                    "Customer with email or mobile number already exist!. Please sign in",
                  buttonText: "Okay",
                  type: "danger",
                });
              }
              if (
                response?.response?.data?.description == "OTP validation failed"
              ) {
                Alert.alert(response?.response?.data?.description);
                navigation.goBack();
              }
              ...
              >
                <View style={{ flex: 1 }}>
                  <Text
                    style={
                      nameValidation
                        ? { color: "#e1171e", fontSize: 12 }
                        : { color: "#727272", fontSize: 12 }
                    }
                  >
                    Name*
                  </Text>
                ...
                <View style={{ justifyContent: "center" }}>
                  <Icon
                    name="user"
                    type="Entypo"
                    style={{ color: "#C3C3C3", fontSize: 20 }}
                  />
                </View>
              </View>
              {nameErrorText ? (
                ...
                >
                  ...
                  <View style={{ flex: 1, marginLeft: -8 }}>
                    <Text style={{ textAlign: "center", fontSize: 14 }}>
                      Get updates on your orders and other important
