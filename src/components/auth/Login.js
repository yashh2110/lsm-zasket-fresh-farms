...
const Login = ({
  ...
  const [trueCallerButtonVisiable, setTrueCallerButtonVisiable] = useState(
    false
  );
  ...
  useEffect(() => {
    if (Platform.OS == "android") {
      ...
      TRUECALLERDEFAULT.on(
        TRUECALLER.TRUECALLER_EVENT.TrueProfileResponse,
        (profile) => {
          //callback executed
      ...
      TRUECALLERDEFAULT.on(
        TRUECALLER.TRUECALLER_EVENT.TrueProfileResponseError,
        (error) => {
        ...
        await trueCallerSign(payLoad, async (response, status) => {
          ...
          if (status) {
            ...
            if (
              ...
              "Customer with details doesn't exist!!. Please sign Up"
            ) {
              ...
              navigation.navigate("EmailScreen", {
                mode: "trueCaller",
                payLoadRes: trueCallerResponse?.payload,
                signature: trueCallerResponse?.signature,
                signatureAlgorithm: trueCallerResponse?.signatureAlgorithm,
                firstName: trueCallerResponse?.firstName,
              });
            }
          }
        });
  ...
  const handleClick = (option) => {
    if (option == "TERMS") {
      Linking.canOpenURL(
        "https://www.zasket.in/terms-and-conditions.html"
      ).then((supported) => {
        if (supported) {
      ...
      Linking.canOpenURL("https://www.zasket.in/privacy-policy.html").then(
        (supported) => {
          if (supported) {
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      {/* <Text>dcsdu</Text> */}
      <View
        style={[styles.container, darkMode ? styles.darkBackGroundColor : null]}
      >
        {Platform.OS == "android" && trueCallerButtonVisiable == true ? (
          ...
          >
            ...
            <Text style={{ marginTop: "2%", fontSize: 13, color: "#727272" }}>
            ...
            <View style={{ flex: 1, marginTop: "9%", zIndex: 1 }}>
              ...
              >
                ...
                <View
                  style={{ backgroundColor: "grey", width: 0.5, margin: 13 }}
                />
                <View style={{ flex: 1 }}>
                  <TextInput
              ...
              {loading ? (
                ...
                >
                  <Text style={{ textTransform: "capitalize" }}>Continue</Text>
                </Button>
              )}
              <View style={{ marginTop: 18, zIndex: 1 }}>
                ...
                >
                  By proceeding to create your account you are agreeing
                </Text>
                <Text
                  onPress={() => handleClick("TERMS")}
                  style={{
                    fontSize: 12,
                    color: "#727272",
                    textAlign: "center",
          ...
          >
            ...
            <Text style={{ marginTop: "2%", fontSize: 14, color: "#727272" }}>
              Login or Sign up to get started
            </Text>
