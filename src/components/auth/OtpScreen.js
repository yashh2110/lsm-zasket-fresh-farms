  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss} accessible={false}>
      ...
      >
        ...
        >
          <View
            style={{ width: "90%", alignSelf: "center", flex: 1, zIndex: 1 }}
          >
            <TouchableOpacity
            ...
            <Text style={{ marginTop: "2%", fontSize: 14, color: "#727272" }}>
              We sent an SMS with OTP to {mobileNumber}{" "}
            </Text>
            <View style={{ flex: 1, marginTop: "15%" }}>
              ...
              >
                <Text style={{ alignSelf: "center", color: "#727272" }}>
                  Didn't receive OTP?{" "}
                </Text>
              </View>
              {disabled ? (
                ...
                >
                  <Text style={{ alignSelf: "center", color: "#c00000" }}>
                    Resend OTP
                  </Text>
                </TouchableOpacity>
              )}
              ...
              {loading ? (
                ...
                <Button
                  ...
                  onPress={() => onSubmit()}
                >
                  <Text style={{ textTransform: "capitalize" }}>Confirm</Text>
                </Button>
              )}
            </View>
          </View>
