    ...
    return (
        <>
            ...
            /> */}
                ...
                />
                <Text style={{ color: "#449005", fontSize: 18, fontWeight: 'bold', marginTop: "10%" }}>Thank you for your order</Text>
                <Text style={{ color: "#727272", fontSize: 14, textAlign: 'center', width: '80%' }}>We are currently processing your order.
                    You can find updates to your order under <Text onPress={() => {
                        ...
                        navigation.pop()
                    }} style={{ color: Theme.Colors.primary, fontWeight: "bold", fontSize: 14 }}>My orders</Text>.</Text>
                <Text style={{ fontSize: 14, color: "#727272", marginTop: 30 }}>Your order will arrive on </Text>
